...
<template>
    <div>
        <h1>Canvas</h1>
        <div class="flex flex-wrap content-around bg-gray-200 h-96">
            <!-- 合成するcanvasその1 -->
            ...
            <div class="place-items-auto">
                <p><button type="button" id="btn-concat" @click="imgComp">
                        <svg width="16" height="16" fill="currentColor" class="bi bi-caret-right" viewBox="0 0 16 16">
                            <path
            ...
            <div class="place-items-auto">
                <p id="eraser">
                    <button type="button" id="btn-eraser" @click="imgClear">
                        <svg width="16" height="16" fill="currentColor" class="bi bi-slack" viewBox="0 0 16 16">
                            <path
            ...
            <div class="place-items-auto">
                <p id="eraser">
                    <button type="button" id="btn-eraser" @click="getImage">
                        <svg width="16" height="16" fill="currentColor" class="bi bi-cloud-download"
                            viewBox="0 0 16 16">
                            <path
